...
namespace LWCSGL.OpenGL
{
    ...
    /// OpenGL 3.0_PTR APIs
    /// </summary>
    public unsafe static class GL30_PTR
    {
        ...
        private static delegate* unmanaged[Stdcall]<uint, uint, char*, void> _glBindFragDataLocation;
        ...
        private static delegate* unmanaged[Stdcall]<uint, int, float*, void> _glClearBufferfv;
        private static delegate* unmanaged[Stdcall]<uint, int, int*, void> _glClearBufferiv;
        private static delegate* unmanaged[Stdcall]<uint, int, uint*, void> _glClearBufferuiv;
        private static delegate* unmanaged[Stdcall]<uint, bool, bool, bool, bool, void> _glColorMaski;
        private static delegate* unmanaged[Stdcall]<int, uint*, void> _glDeleteFramebuffers;
        private static delegate* unmanaged[Stdcall]<int, uint*, void> _glDeleteRenderbuffers;
        private static delegate* unmanaged[Stdcall]<int, uint*, void> _glDeleteVertexArrays;
        ...
        private static delegate* unmanaged[Stdcall]<int, uint*, void> _glGenFramebuffers;
        private static delegate* unmanaged[Stdcall]<int, uint*, void> _glGenRenderbuffers;
        private static delegate* unmanaged[Stdcall]<int, uint*, void> _glGenVertexArrays;
        private static delegate* unmanaged[Stdcall]<uint, void> _glGenerateMipmap;
        private static delegate* unmanaged[Stdcall]<uint, uint, bool*, void> _glGetBooleani_v;
        private static delegate* unmanaged[Stdcall]<uint, char*, int> _glGetFragDataLocation;
        private static delegate* unmanaged[Stdcall]<uint, uint, uint, int*, void> _glGetFramebufferAttachmentParameteriv;
        private static delegate* unmanaged[Stdcall]<uint, uint, int*, void> _glGetIntegeri_v;
        private static delegate* unmanaged[Stdcall]<uint, uint, int*, void> _glGetRenderbufferParameteriv;
        private static delegate* unmanaged[Stdcall]<uint, uint, byte*> _glGetStringi;
        private static delegate* unmanaged[Stdcall]<uint, uint, int*, void> _glGetTexParameterIiv;
        private static delegate* unmanaged[Stdcall]<uint, uint, uint*, void> _glGetTexParameterIuiv;
        private static delegate* unmanaged[Stdcall]<uint, uint, int, int*, int*, uint*, char*, void> _glGetTransformFeedbackVarying;
        private static delegate* unmanaged[Stdcall]<uint, int, uint*, void> _glGetUniformuiv;
        private static delegate* unmanaged[Stdcall]<uint, uint, int*, void> _glGetVertexAttribIiv;
        private static delegate* unmanaged[Stdcall]<uint, uint, uint*, void> _glGetVertexAttribIuiv;
        ...
        private static delegate* unmanaged[Stdcall]<uint, nint, nint, uint, void*> _glMapBufferRange;
        ...
        private static delegate* unmanaged[Stdcall]<uint, uint, int*, void> _glTexParameterIiv;
        private static delegate* unmanaged[Stdcall]<uint, uint, uint*, void> _glTexParameterIuiv;
        private static delegate* unmanaged[Stdcall]<uint, int, char**, uint, void> _glTransformFeedbackVaryings;
        private static delegate* unmanaged[Stdcall]<int, uint, void> _glUniform1ui;
        private static delegate* unmanaged[Stdcall]<int, int, uint*, void> _glUniform1uiv;
        private static delegate* unmanaged[Stdcall]<int, uint, uint, void> _glUniform2ui;
        private static delegate* unmanaged[Stdcall]<int, int, uint*, void> _glUniform2uiv;
        private static delegate* unmanaged[Stdcall]<int, uint, uint, uint, void> _glUniform3ui;
        private static delegate* unmanaged[Stdcall]<int, int, uint*, void> _glUniform3uiv;
        private static delegate* unmanaged[Stdcall]<int, uint, uint, uint, uint, void> _glUniform4ui;
        private static delegate* unmanaged[Stdcall]<int, int, uint*, void> _glUniform4uiv;
        private static delegate* unmanaged[Stdcall]<uint, int, void> _glVertexAttribI1i;
        private static delegate* unmanaged[Stdcall]<uint, int*, void> _glVertexAttribI1iv;
        private static delegate* unmanaged[Stdcall]<uint, uint, void> _glVertexAttribI1ui;
        private static delegate* unmanaged[Stdcall]<uint, uint*, void> _glVertexAttribI1uiv;
        private static delegate* unmanaged[Stdcall]<uint, int, int, void> _glVertexAttribI2i;
        private static delegate* unmanaged[Stdcall]<uint, int*, void> _glVertexAttribI2iv;
        private static delegate* unmanaged[Stdcall]<uint, uint, uint, void> _glVertexAttribI2ui;
        private static delegate* unmanaged[Stdcall]<uint, uint*, void> _glVertexAttribI2uiv;
        private static delegate* unmanaged[Stdcall]<uint, int, int, int, void> _glVertexAttribI3i;
        private static delegate* unmanaged[Stdcall]<uint, int*, void> _glVertexAttribI3iv;
        private static delegate* unmanaged[Stdcall]<uint, uint, uint, uint, void> _glVertexAttribI3ui;
        private static delegate* unmanaged[Stdcall]<uint, uint*, void> _glVertexAttribI3uiv;
        private static delegate* unmanaged[Stdcall]<uint, sbyte*, void> _glVertexAttribI4bv;
        private static delegate* unmanaged[Stdcall]<uint, int, int, int, int, void> _glVertexAttribI4i;
        private static delegate* unmanaged[Stdcall]<uint, int*, void> _glVertexAttribI4iv;
        private static delegate* unmanaged[Stdcall]<uint, short*, void> _glVertexAttribI4sv;
        private static delegate* unmanaged[Stdcall]<uint, byte*, void> _glVertexAttribI4ubv;
        private static delegate* unmanaged[Stdcall]<uint, uint, uint, uint, uint, void> _glVertexAttribI4ui;
        private static delegate* unmanaged[Stdcall]<uint, uint*, void> _glVertexAttribI4uiv;
        private static delegate* unmanaged[Stdcall]<uint, ushort*, void> _glVertexAttribI4usv;
        private static delegate* unmanaged[Stdcall]<uint, int, uint, int, void*, void> _glVertexAttribIPointer;
        ...
        public static void glBindFragDataLocation(uint program, uint color, char* name) { _glBindFragDataLocation(program, color, name); }
        ...
        public static int glGetFragDataLocation(uint program, char* name) { return _glGetFragDataLocation(program, name); }
        ...
        public static byte* glGetStringi(uint name, uint index) { return _glGetStringi(name, index); }
        ...
        public static void glGetTransformFeedbackVarying(uint program, uint index, int bufSize, int* length, int* size, uint* type, char* name) { _glGetTransformFeedbackVarying(program, index, bufSize, length, size, type, name); }
        ...
        public static void* glMapBufferRange(uint target, nint offset, nint length, uint access) { return _glMapBufferRange(target, offset, length, access); }
        ...
        public static void glTransformFeedbackVaryings(uint program, int count, char** varyings, uint bufferMode) { _glTransformFeedbackVaryings(program, count, varyings, bufferMode); }
        ...
        internal static void Load(DelegatePtrSource src)
        {
            ...
            _glBindFragDataLocation = (delegate* unmanaged[Stdcall]<uint, uint, char*, void>)src.GetFuncPtr("glBindFragDataLocation");
            ...
            _glClearBufferfv = (delegate* unmanaged[Stdcall]<uint, int, float*, void>)src.GetFuncPtr("glClearBufferfv");
            _glClearBufferiv = (delegate* unmanaged[Stdcall]<uint, int, int*, void>)src.GetFuncPtr("glClearBufferiv");
            _glClearBufferuiv = (delegate* unmanaged[Stdcall]<uint, int, uint*, void>)src.GetFuncPtr("glClearBufferuiv");
            _glColorMaski = (delegate* unmanaged[Stdcall]<uint, bool, bool, bool, bool, void>)src.GetFuncPtr("glColorMaski");
            _glDeleteFramebuffers = (delegate* unmanaged[Stdcall]<int, uint*, void>)src.GetFuncPtr("glDeleteFramebuffers");
            _glDeleteRenderbuffers = (delegate* unmanaged[Stdcall]<int, uint*, void>)src.GetFuncPtr("glDeleteRenderbuffers");
            _glDeleteVertexArrays = (delegate* unmanaged[Stdcall]<int, uint*, void>)src.GetFuncPtr("glDeleteVertexArrays");
            ...
            _glGenFramebuffers = (delegate* unmanaged[Stdcall]<int, uint*, void>)src.GetFuncPtr("glGenFramebuffers");
            _glGenRenderbuffers = (delegate* unmanaged[Stdcall]<int, uint*, void>)src.GetFuncPtr("glGenRenderbuffers");
            _glGenVertexArrays = (delegate* unmanaged[Stdcall]<int, uint*, void>)src.GetFuncPtr("glGenVertexArrays");
            _glGenerateMipmap = (delegate* unmanaged[Stdcall]<uint, void>)src.GetFuncPtr("glGenerateMipmap");
            _glGetBooleani_v = (delegate* unmanaged[Stdcall]<uint, uint, bool*, void>)src.GetFuncPtr("glGetBooleani_v");
            _glGetFragDataLocation = (delegate* unmanaged[Stdcall]<uint, char*, int>)src.GetFuncPtr("glGetFragDataLocation");
            _glGetFramebufferAttachmentParameteriv = (delegate* unmanaged[Stdcall]<uint, uint, uint, int*, void>)src.GetFuncPtr("glGetFramebufferAttachmentParameteriv");
            _glGetIntegeri_v = (delegate* unmanaged[Stdcall]<uint, uint, int*, void>)src.GetFuncPtr("glGetIntegeri_v");
            _glGetRenderbufferParameteriv = (delegate* unmanaged[Stdcall]<uint, uint, int*, void>)src.GetFuncPtr("glGetRenderbufferParameteriv");
            _glGetStringi = (delegate* unmanaged[Stdcall]<uint, uint, byte*>)src.GetFuncPtr("glGetStringi");
            _glGetTexParameterIiv = (delegate* unmanaged[Stdcall]<uint, uint, int*, void>)src.GetFuncPtr("glGetTexParameterIiv");
            _glGetTexParameterIuiv = (delegate* unmanaged[Stdcall]<uint, uint, uint*, void>)src.GetFuncPtr("glGetTexParameterIuiv");
            _glGetTransformFeedbackVarying = (delegate* unmanaged[Stdcall]<uint, uint, int, int*, int*, uint*, char*, void>)src.GetFuncPtr("glGetTransformFeedbackVarying");
            _glGetUniformuiv = (delegate* unmanaged[Stdcall]<uint, int, uint*, void>)src.GetFuncPtr("glGetUniformuiv");
            _glGetVertexAttribIiv = (delegate* unmanaged[Stdcall]<uint, uint, int*, void>)src.GetFuncPtr("glGetVertexAttribIiv");
            _glGetVertexAttribIuiv = (delegate* unmanaged[Stdcall]<uint, uint, uint*, void>)src.GetFuncPtr("glGetVertexAttribIuiv");
            ...
            _glMapBufferRange = (delegate* unmanaged[Stdcall]<uint, nint, nint, uint, void*>)src.GetFuncPtr("glMapBufferRange");
            ...
            _glTexParameterIiv = (delegate* unmanaged[Stdcall]<uint, uint, int*, void>)src.GetFuncPtr("glTexParameterIiv");
            _glTexParameterIuiv = (delegate* unmanaged[Stdcall]<uint, uint, uint*, void>)src.GetFuncPtr("glTexParameterIuiv");
            _glTransformFeedbackVaryings = (delegate* unmanaged[Stdcall]<uint, int, char**, uint, void>)src.GetFuncPtr("glTransformFeedbackVaryings");
            _glUniform1ui = (delegate* unmanaged[Stdcall]<int, uint, void>)src.GetFuncPtr("glUniform1ui");
            _glUniform1uiv = (delegate* unmanaged[Stdcall]<int, int, uint*, void>)src.GetFuncPtr("glUniform1uiv");
            _glUniform2ui = (delegate* unmanaged[Stdcall]<int, uint, uint, void>)src.GetFuncPtr("glUniform2ui");
            _glUniform2uiv = (delegate* unmanaged[Stdcall]<int, int, uint*, void>)src.GetFuncPtr("glUniform2uiv");
            _glUniform3ui = (delegate* unmanaged[Stdcall]<int, uint, uint, uint, void>)src.GetFuncPtr("glUniform3ui");
            _glUniform3uiv = (delegate* unmanaged[Stdcall]<int, int, uint*, void>)src.GetFuncPtr("glUniform3uiv");
            _glUniform4ui = (delegate* unmanaged[Stdcall]<int, uint, uint, uint, uint, void>)src.GetFuncPtr("glUniform4ui");
            _glUniform4uiv = (delegate* unmanaged[Stdcall]<int, int, uint*, void>)src.GetFuncPtr("glUniform4uiv");
            _glVertexAttribI1i = (delegate* unmanaged[Stdcall]<uint, int, void>)src.GetFuncPtr("glVertexAttribI1i");
            _glVertexAttribI1iv = (delegate* unmanaged[Stdcall]<uint, int*, void>)src.GetFuncPtr("glVertexAttribI1iv");
            _glVertexAttribI1ui = (delegate* unmanaged[Stdcall]<uint, uint, void>)src.GetFuncPtr("glVertexAttribI1ui");
            _glVertexAttribI1uiv = (delegate* unmanaged[Stdcall]<uint, uint*, void>)src.GetFuncPtr("glVertexAttribI1uiv");
            _glVertexAttribI2i = (delegate* unmanaged[Stdcall]<uint, int, int, void>)src.GetFuncPtr("glVertexAttribI2i");
            _glVertexAttribI2iv = (delegate* unmanaged[Stdcall]<uint, int*, void>)src.GetFuncPtr("glVertexAttribI2iv");
            _glVertexAttribI2ui = (delegate* unmanaged[Stdcall]<uint, uint, uint, void>)src.GetFuncPtr("glVertexAttribI2ui");
            _glVertexAttribI2uiv = (delegate* unmanaged[Stdcall]<uint, uint*, void>)src.GetFuncPtr("glVertexAttribI2uiv");
            _glVertexAttribI3i = (delegate* unmanaged[Stdcall]<uint, int, int, int, void>)src.GetFuncPtr("glVertexAttribI3i");
            _glVertexAttribI3iv = (delegate* unmanaged[Stdcall]<uint, int*, void>)src.GetFuncPtr("glVertexAttribI3iv");
            _glVertexAttribI3ui = (delegate* unmanaged[Stdcall]<uint, uint, uint, uint, void>)src.GetFuncPtr("glVertexAttribI3ui");
            _glVertexAttribI3uiv = (delegate* unmanaged[Stdcall]<uint, uint*, void>)src.GetFuncPtr("glVertexAttribI3uiv");
            _glVertexAttribI4bv = (delegate* unmanaged[Stdcall]<uint, sbyte*, void>)src.GetFuncPtr("glVertexAttribI4bv");
            _glVertexAttribI4i = (delegate* unmanaged[Stdcall]<uint, int, int, int, int, void>)src.GetFuncPtr("glVertexAttribI4i");
            _glVertexAttribI4iv = (delegate* unmanaged[Stdcall]<uint, int*, void>)src.GetFuncPtr("glVertexAttribI4iv");
            _glVertexAttribI4sv = (delegate* unmanaged[Stdcall]<uint, short*, void>)src.GetFuncPtr("glVertexAttribI4sv");
            _glVertexAttribI4ubv = (delegate* unmanaged[Stdcall]<uint, byte*, void>)src.GetFuncPtr("glVertexAttribI4ubv");
            _glVertexAttribI4ui = (delegate* unmanaged[Stdcall]<uint, uint, uint, uint, uint, void>)src.GetFuncPtr("glVertexAttribI4ui");
            _glVertexAttribI4uiv = (delegate* unmanaged[Stdcall]<uint, uint*, void>)src.GetFuncPtr("glVertexAttribI4uiv");
            _glVertexAttribI4usv = (delegate* unmanaged[Stdcall]<uint, ushort*, void>)src.GetFuncPtr("glVertexAttribI4usv");
            _glVertexAttribIPointer = (delegate* unmanaged[Stdcall]<uint, int, uint, int, void*, void>)src.GetFuncPtr("glVertexAttribIPointer");
        }
