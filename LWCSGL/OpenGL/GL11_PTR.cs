...
namespace LWCSGL.OpenGL
{
    ...
    /// OpenGL 1.1_PTR APIs
    /// </summary>
    public unsafe static class GL11_PTR
    {
        ...
        private static delegate* unmanaged[Stdcall]<int, uint, void*, void> _glCallLists;
        ...
        private static delegate* unmanaged[Stdcall]<int, uint, int, void*, void> _glColorPointer;
        ...
        private static delegate* unmanaged[Stdcall]<uint, int, uint, void*, void> _glDrawElements;
        private static delegate* unmanaged[Stdcall]<int, int, uint, uint, void*, void> _glDrawPixels;
        private static delegate* unmanaged[Stdcall]<bool, void> _glEdgeFlag;
        private static delegate* unmanaged[Stdcall]<int, void*, void> _glEdgeFlagPointer;
        ...
        private static delegate* unmanaged[Stdcall]<uint, void**, void> _glGetPointerv;
        private static delegate* unmanaged[Stdcall]<byte*, void> _glGetPolygonStipple;
        private static delegate* unmanaged[Stdcall]<uint, byte*> _glGetString;
        ...
        private static delegate* unmanaged[Stdcall]<uint, int, uint, uint, void*, void> _glGetTexImage;
        ...
        private static delegate* unmanaged[Stdcall]<uint, int, void*, void> _glIndexPointer;
        ...
        private static delegate* unmanaged[Stdcall]<uint, int, void*, void> _glInterleavedArrays;
        ...
        private static delegate* unmanaged[Stdcall]<uint, int, void*, void> _glNormalPointer;
        ...
        private static delegate* unmanaged[Stdcall]<int, int, int, int, uint, uint, void*, void> _glReadPixels;
        ...
        private static delegate* unmanaged[Stdcall]<int, uint, int, void*, void> _glTexCoordPointer;
        ...
        private static delegate* unmanaged[Stdcall]<uint, int, int, int, int, uint, uint, void*, void> _glTexImage1D;
        private static delegate* unmanaged[Stdcall]<uint, int, int, int, int, int, uint, uint, void*, void> _glTexImage2D;
        ...
        private static delegate* unmanaged[Stdcall]<uint, int, int, int, uint, uint, void*, void> _glTexSubImage1D;
        private static delegate* unmanaged[Stdcall]<uint, int, int, int, int, int, uint, uint, void*, void> _glTexSubImage2D;
        ...
        private static delegate* unmanaged[Stdcall]<int, uint, int, void*, void> _glVertexPointer;
        ...
        public static byte* glGetString(uint name) { return _glGetString(name); }
        ...
        internal static void Load(DelegatePtrSource src)
        {
            ...
            _glCallLists = (delegate* unmanaged[Stdcall]<int, uint, void*, void>)src.GetFuncPtr("glCallLists");
            ...
            _glColorPointer = (delegate* unmanaged[Stdcall]<int, uint, int, void*, void>)src.GetFuncPtr("glColorPointer");
            ...
            _glDrawElements = (delegate* unmanaged[Stdcall]<uint, int, uint, void*, void>)src.GetFuncPtr("glDrawElements");
            _glDrawPixels = (delegate* unmanaged[Stdcall]<int, int, uint, uint, void*, void>)src.GetFuncPtr("glDrawPixels");
            _glEdgeFlag = (delegate* unmanaged[Stdcall]<bool, void>)src.GetFuncPtr("glEdgeFlag");
            _glEdgeFlagPointer = (delegate* unmanaged[Stdcall]<int, void*, void>)src.GetFuncPtr("glEdgeFlagPointer");
            ...
            _glGetPointerv = (delegate* unmanaged[Stdcall]<uint, void**, void>)src.GetFuncPtr("glGetPointerv");
            _glGetPolygonStipple = (delegate* unmanaged[Stdcall]<byte*, void>)src.GetFuncPtr("glGetPolygonStipple");
            _glGetString = (delegate* unmanaged[Stdcall]<uint, byte*>)src.GetFuncPtr("glGetString");
            ...
            _glGetTexImage = (delegate* unmanaged[Stdcall]<uint, int, uint, uint, void*, void>)src.GetFuncPtr("glGetTexImage");
            ...
            _glIndexPointer = (delegate* unmanaged[Stdcall]<uint, int, void*, void>)src.GetFuncPtr("glIndexPointer");
            ...
            _glInterleavedArrays = (delegate* unmanaged[Stdcall]<uint, int, void*, void>)src.GetFuncPtr("glInterleavedArrays");
            ...
            _glNormalPointer = (delegate* unmanaged[Stdcall]<uint, int, void*, void>)src.GetFuncPtr("glNormalPointer");
            ...
            _glReadPixels = (delegate* unmanaged[Stdcall]<int, int, int, int, uint, uint, void*, void>)src.GetFuncPtr("glReadPixels");
            ...
            _glTexCoordPointer = (delegate* unmanaged[Stdcall]<int, uint, int, void*, void>)src.GetFuncPtr("glTexCoordPointer");
            ...
            _glTexImage1D = (delegate* unmanaged[Stdcall]<uint, int, int, int, int, uint, uint, void*, void>)src.GetFuncPtr("glTexImage1D");
            _glTexImage2D = (delegate* unmanaged[Stdcall]<uint, int, int, int, int, int, uint, uint, void*, void>)src.GetFuncPtr("glTexImage2D");
            ...
            _glTexSubImage1D = (delegate* unmanaged[Stdcall]<uint, int, int, int, uint, uint, void*, void>)src.GetFuncPtr("glTexSubImage1D");
            _glTexSubImage2D = (delegate* unmanaged[Stdcall]<uint, int, int, int, int, int, uint, uint, void*, void>)src.GetFuncPtr("glTexSubImage2D");
            ...
            _glVertexPointer = (delegate* unmanaged[Stdcall]<int, uint, int, void*, void>)src.GetFuncPtr("glVertexPointer");
