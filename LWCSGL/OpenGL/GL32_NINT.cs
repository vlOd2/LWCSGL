...
{
    /// <summary>
    /// OpenGL 3.2_NINT APIs
    /// </summary>
    public unsafe static class GL32_NINT
    {
        ...
        private static delegate* unmanaged[Stdcall]<uint, int, uint, nint, int, void> _glDrawElementsBaseVertex;
        private static delegate* unmanaged[Stdcall]<uint, int, uint, nint, int, int, void> _glDrawElementsInstancedBaseVertex;
        private static delegate* unmanaged[Stdcall]<uint, uint, uint, int, uint, nint, int, void> _glDrawRangeElementsBaseVertex;
        ...
        private static delegate* unmanaged[Stdcall]<uint, uint, nint, void> _glGetBufferParameteri64v;
        private static delegate* unmanaged[Stdcall]<uint, uint, nint, void> _glGetInteger64i_v;
        private static delegate* unmanaged[Stdcall]<uint, nint, void> _glGetInteger64v;
        private static delegate* unmanaged[Stdcall]<uint, uint, nint, void> _glGetMultisamplefv;
        private static delegate* unmanaged[Stdcall]<nint, uint, int, nint, nint, void> _glGetSynciv;
        private static delegate* unmanaged[Stdcall]<nint, bool> _glIsSync;
        private static delegate* unmanaged[Stdcall]<uint, nint, uint, nint, int, nint, void> _glMultiDrawElementsBaseVertex;
        ...
        public static void glDrawElementsBaseVertex(uint mode, int count, uint type, nint indices, int basevertex) { _glDrawElementsBaseVertex(mode, count, type, indices, basevertex); }
        public static void glDrawElementsInstancedBaseVertex(uint mode, int count, uint type, nint indices, int instancecount, int basevertex) { _glDrawElementsInstancedBaseVertex(mode, count, type, indices, instancecount, basevertex); }
        public static void glDrawRangeElementsBaseVertex(uint mode, uint start, uint end, int count, uint type, nint indices, int basevertex) { _glDrawRangeElementsBaseVertex(mode, start, end, count, type, indices, basevertex); }
        ...
        public static void glGetBufferParameteri64v(uint target, uint pname, nint @params) { _glGetBufferParameteri64v(target, pname, @params); }
        public static void glGetInteger64i_v(uint target, uint index, nint data) { _glGetInteger64i_v(target, index, data); }
        public static void glGetInteger64v(uint pname, nint data) { _glGetInteger64v(pname, data); }
        public static void glGetMultisamplefv(uint pname, uint index, nint val) { _glGetMultisamplefv(pname, index, val); }
        public static void glGetSynciv(nint sync, uint pname, int count, nint length, nint values) { _glGetSynciv(sync, pname, count, length, values); }
        public static bool glIsSync(nint sync) { return _glIsSync(sync); }
        public static void glMultiDrawElementsBaseVertex(uint mode, nint count, uint type, nint indices, int drawcount, nint basevertex) { _glMultiDrawElementsBaseVertex(mode, count, type, indices, drawcount, basevertex); }
        ...
        internal static void Load(DelegatePtrSource src)
        {
            ...
            _glDrawElementsBaseVertex = (delegate* unmanaged[Stdcall]<uint, int, uint, nint, int, void>)src.GetFuncPtr("glDrawElementsBaseVertex");
            _glDrawElementsInstancedBaseVertex = (delegate* unmanaged[Stdcall]<uint, int, uint, nint, int, int, void>)src.GetFuncPtr("glDrawElementsInstancedBaseVertex");
            _glDrawRangeElementsBaseVertex = (delegate* unmanaged[Stdcall]<uint, uint, uint, int, uint, nint, int, void>)src.GetFuncPtr("glDrawRangeElementsBaseVertex");
            ...
            _glGetBufferParameteri64v = (delegate* unmanaged[Stdcall]<uint, uint, nint, void>)src.GetFuncPtr("glGetBufferParameteri64v");
            _glGetInteger64i_v = (delegate* unmanaged[Stdcall]<uint, uint, nint, void>)src.GetFuncPtr("glGetInteger64i_v");
            _glGetInteger64v = (delegate* unmanaged[Stdcall]<uint, nint, void>)src.GetFuncPtr("glGetInteger64v");
            _glGetMultisamplefv = (delegate* unmanaged[Stdcall]<uint, uint, nint, void>)src.GetFuncPtr("glGetMultisamplefv");
            _glGetSynciv = (delegate* unmanaged[Stdcall]<nint, uint, int, nint, nint, void>)src.GetFuncPtr("glGetSynciv");
            _glIsSync = (delegate* unmanaged[Stdcall]<nint, bool>)src.GetFuncPtr("glIsSync");
            _glMultiDrawElementsBaseVertex = (delegate* unmanaged[Stdcall]<uint, nint, uint, nint, int, nint, void>)src.GetFuncPtr("glMultiDrawElementsBaseVertex");
