...
namespace LWCSGL.OpenGL
{
    ...
    /// OpenGL 3.2 APIs
    /// </summary>
    public unsafe static class GL32
    {
        ...
        private static delegate* unmanaged[Stdcall]<uint, int[], uint, nint, int, int[], void> _glMultiDrawElementsBaseVertex;
        ...
        public static void glMultiDrawElementsBaseVertex(uint mode, int[] count, uint type, nint indices, int drawcount, int[] basevertex) { _glMultiDrawElementsBaseVertex(mode, count, type, indices, drawcount, basevertex); }
        ...
        internal static void Load(DelegatePtrSource src)
        {
            ...
            _glMultiDrawElementsBaseVertex = (delegate* unmanaged[Stdcall]<uint, int[], uint, nint, int, int[], void>)src.GetFuncPtr("glMultiDrawElementsBaseVertex");
