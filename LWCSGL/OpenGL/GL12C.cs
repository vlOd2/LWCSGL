...
{
    /// <summary>
    /// Constants for OpenGL 1.2
    /// </summary>
    public class GL12C
    {
        public const uint GL_SMOOTH_POINT_SIZE_RANGE = 0x0B12u;
        public const uint GL_SMOOTH_POINT_SIZE_GRANULARITY = 0x0B13u;
        public const uint GL_SMOOTH_LINE_WIDTH_RANGE = 0x0B22u;
        public const uint GL_SMOOTH_LINE_WIDTH_GRANULARITY = 0x0B23u;
        ...
        public const uint GL_RESCALE_NORMAL = 0x803Au;
        ...
        public const uint GL_LIGHT_MODEL_COLOR_CONTROL = 0x81F8u;
        public const uint GL_SINGLE_COLOR = 0x81F9u;
        public const uint GL_SEPARATE_SPECULAR_COLOR = 0x81FAu;
        ...
        public const uint GL_ALIASED_POINT_SIZE_RANGE = 0x846Du;
