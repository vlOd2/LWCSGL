...
namespace LWCSGL.OpenGL
{
    ...
    /// OpenGL 3.1_PTR APIs
    /// </summary>
    public unsafe static class GL31_PTR
    {
        ...
        private static delegate* unmanaged[Stdcall]<uint, int, uint, void*, int, void> _glDrawElementsInstanced;
        private static delegate* unmanaged[Stdcall]<uint, uint, int, int*, char*, void> _glGetActiveUniformBlockName;
        private static delegate* unmanaged[Stdcall]<uint, uint, uint, int*, void> _glGetActiveUniformBlockiv;
        private static delegate* unmanaged[Stdcall]<uint, uint, int, int*, char*, void> _glGetActiveUniformName;
        private static delegate* unmanaged[Stdcall]<uint, int, uint*, uint, int*, void> _glGetActiveUniformsiv;
        private static delegate* unmanaged[Stdcall]<uint, uint, int*, void> _glGetIntegeri_v;
        private static delegate* unmanaged[Stdcall]<uint, char*, uint> _glGetUniformBlockIndex;
        private static delegate* unmanaged[Stdcall]<uint, int, char**, uint*, void> _glGetUniformIndices;
        ...
        public static void glGetActiveUniformBlockName(uint program, uint uniformBlockIndex, int bufSize, int* length, char* uniformBlockName) { _glGetActiveUniformBlockName(program, uniformBlockIndex, bufSize, length, uniformBlockName); }
        ...
        public static void glGetActiveUniformName(uint program, uint uniformIndex, int bufSize, int* length, char* uniformName) { _glGetActiveUniformName(program, uniformIndex, bufSize, length, uniformName); }
        ...
        public static uint glGetUniformBlockIndex(uint program, char* uniformBlockName) { return _glGetUniformBlockIndex(program, uniformBlockName); }
        public static void glGetUniformIndices(uint program, int uniformCount, char** uniformNames, uint* uniformIndices) { _glGetUniformIndices(program, uniformCount, uniformNames, uniformIndices); }
        ...
        internal static void Load(DelegatePtrSource src)
        {
            ...
            _glDrawElementsInstanced = (delegate* unmanaged[Stdcall]<uint, int, uint, void*, int, void>)src.GetFuncPtr("glDrawElementsInstanced");
            _glGetActiveUniformBlockName = (delegate* unmanaged[Stdcall]<uint, uint, int, int*, char*, void>)src.GetFuncPtr("glGetActiveUniformBlockName");
            _glGetActiveUniformBlockiv = (delegate* unmanaged[Stdcall]<uint, uint, uint, int*, void>)src.GetFuncPtr("glGetActiveUniformBlockiv");
            _glGetActiveUniformName = (delegate* unmanaged[Stdcall]<uint, uint, int, int*, char*, void>)src.GetFuncPtr("glGetActiveUniformName");
            _glGetActiveUniformsiv = (delegate* unmanaged[Stdcall]<uint, int, uint*, uint, int*, void>)src.GetFuncPtr("glGetActiveUniformsiv");
            _glGetIntegeri_v = (delegate* unmanaged[Stdcall]<uint, uint, int*, void>)src.GetFuncPtr("glGetIntegeri_v");
            _glGetUniformBlockIndex = (delegate* unmanaged[Stdcall]<uint, char*, uint>)src.GetFuncPtr("glGetUniformBlockIndex");
            _glGetUniformIndices = (delegate* unmanaged[Stdcall]<uint, int, char**, uint*, void>)src.GetFuncPtr("glGetUniformIndices");
