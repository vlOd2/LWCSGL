...
namespace LWCSGL.OpenGL
{
    ...
    /// OpenGL 1.4 APIs
    /// </summary>
    public unsafe static class GL14
    {
        ...
        private static delegate* unmanaged[Stdcall]<uint, int[], uint, nint, int, void> _glMultiDrawElements;
        ...
        public static void glMultiDrawElements(uint mode, int[] count, uint type, nint indices, int drawcount) { _glMultiDrawElements(mode, count, type, indices, drawcount); }
        ...
        internal static void Load(DelegatePtrSource src)
        {
            ...
            _glMultiDrawElements = (delegate* unmanaged[Stdcall]<uint, int[], uint, nint, int, void>)src.GetFuncPtr("glMultiDrawElements");
